...
cloonix_ssh nemo router1 "ip addr add dev eth1 10.0.2.1/24"
cloonix_ssh nemo router1 "ip addr add dev eth2 10.1.0.1/30"

cloonix_ssh nemo router2 "ip addr add dev eth0 10.1.0.2/30"
cloonix_ssh nemo router2 "ip addr add dev eth1 192.168.0.1/24"

cloonix_ssh nemo five "ip addr add dev eth0 192.168.0.2/24"
...
#----------------------------------------------------------------------
cloonix_ssh nemo five "ip route add default via 192.168.0.1"
...
for h in one two three four; do
  cloonix_ssh nemo $h "dhclient eth0"
done
